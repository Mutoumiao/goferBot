...
type: feature-spec
status: approved
summary: 提供登录页（/login）和注册页（/register），支持邮箱+密码表单校验、错误反馈、登录态持久化及登录后跳转，范围外排除第三方登录与密码重置。
---
# Feature Spec: 认证页面（登录 / 注册）

> 关联 issue: `docs/issues/f-01-auth-pages.md`
> 关联 ADR: `docs/adrs/0004-cloud-native-rearchitecture.md`
> 日期: 2026-05-16
