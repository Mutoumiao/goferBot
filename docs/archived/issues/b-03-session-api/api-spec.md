---
issue_id: b-03-session-api
type: api-spec
status: approved
summary: 会话管理 5 端点：列表 GET /sessions（含消息数，倒序）、详情 GET /sessions/:id（含消息列表）、创建 POST /sessions、重命名 PATCH /sessions/:id、级联删除 DELETE /sessions/:id，JWT 认证。
---
