...
type: api-spec
status: approved
summary: 内部服务接口（无 REST）：MilvusVectorStore 实现 IVectorStore，提供 ensureCollection/ insertVectors/ searchVectors/ deleteVectors 方法签名、SearchOptions 配置与 VectorStoreError 错误定义。
---
