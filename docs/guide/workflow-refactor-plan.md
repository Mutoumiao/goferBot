...
> 状态：待评审
> 日期：2026-05-20
> 背景：`issues/` `03-specs/` `04-plans/` 目录分散、命名混乱、维护困难
...
1. 备份当前 `docs/issues/` `03-specs/` `04-plans/`
2. 创建 `docs/issues/` 目录
...
cp docs/issues/f-15-global-tab-bar.md docs/issues/f-15-global-tab-bar/issue.md
...
1. 删除旧目录 `issues/` `03-specs/` `04-plans/`
2. 更新 `docs/guide/workflow.md`
3. 更新所有 skill 文档
