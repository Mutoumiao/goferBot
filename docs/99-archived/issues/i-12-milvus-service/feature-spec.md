...
type: feature-spec
status: approved
summary: 将 MilvusVectorStore 封装为 NestJS @Injectable/@Global VectorService，从 ConfigService 读取配置，提供 ensureCollection/insertVectors/searchVectors/deleteByIds 方法，复用 IVectorStore 接口。
---
