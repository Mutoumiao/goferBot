...
type: api-spec
status: approved
summary: 内部 NestJS 服务（无 REST）：VectorModule @Global 定义、VectorService 方法签名（ensureCollection/insertVectors/searchVectors/deleteByIds），ConfigService 配置键与 IVectorStore 实现契约。
---
