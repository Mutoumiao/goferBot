...
tc_count: 38
status: drafted
summary: 测试 Better Auth 认证系统集成：邮箱+密码注册/登录/登出/会话查询 API，覆盖正常流程、错误场景（邮箱重复、密码错误等）、速率限制、安全头验证和 Cookie 属性校验。
---
...
> 规格引用:
> - `docs/03-specs/b-01-auth-api/feature-spec.md`
> - `docs/03-specs/b-01-auth-api/api-spec.md`
> - `docs/03-specs/b-01-auth-api/behavior-spec.md`
> - `docs/04-plans/b-01-auth-api/v1.md`
