...
export function KbListPage() {
  const { entries, setEntries, setIsLoading: setKbLoading, selectedId } = useKbStore()

  const { isLoading: fileLoading, error: fileError, breadcrumb } = useFileStore()
  ...
  return (
    <div className="relative flex h-full overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-auto bg-[#f0f1f5] p-4">
        {!selectedId ? (
